...
function startDiscovery(myAdvert, networkChange) {
  //
  ...
  c.on("added", function (obj) {
      ...
      c.eachNode(function (node) {
          console.log('added:', node.advertisement);
          nodeList.push(node);
      });
  ...
  c.on("removed", function (obj) {
      ...
      var nodeList = [c.me];
      c.eachNode(function (node) {
          console.log('removed:', node.advertisement);
          nodeList.push(node);
      });
      networkChange(nodeList);
  });
